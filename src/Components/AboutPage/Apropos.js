...
export default function Apropos() {
    return (
        <>
            ...
            <Paragraph>
                Passionné par le monde de la <b>communication</b>, de la <b>vidéo</b>, et plus récemment par le <b>développement web</b>, me voilà aujourd’hui en quête de nouvelles expériences qui puissent enrichir mes compétences dans le domaine du digital. 
